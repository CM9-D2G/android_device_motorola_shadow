...
SHADOW_BOOT_OUT := $(PRODUCT_OUT)/droid2we-boot
SHADOW_BOOT_OUT_UNSTRIPPED := $(TARGET_OUT_UNSTRIPPED)/droid2we-boot
...
SHADOW_BOOT_OTA_PACKAGE_TARGET := $(PRODUCT_OUT)/droid2we-boot.zip
...
SHADOW_BOOT := $(TARGET_OUT_ETC)/droid2we-boot.zip
